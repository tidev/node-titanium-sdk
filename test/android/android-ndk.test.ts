...
describe('Android NDK', () => {
	...
	describe('load()', () => {
		...
		it('should error if directory does not exist', async () => {
			await expect(AndroidNDK.load(path.join(__dirname, 'doesnotexist')))
		...
		it('should error if directory is missing the "build" directory', async () => {
			await expect(AndroidNDK.load(path.join(__dirname, 'mocks', 'ndk', 'all', 'no-build-dir')))
		...
		it('should error if directory is missing the "platforms" directory', async () => {
			await expect(AndroidNDK.load(path.join(__dirname, 'mocks', 'ndk', 'all', 'no-platforms-dir')))
		...
		it('should error if directory is missing the "ndk-build" executable', async () => {
			await expect(AndroidNDK.load(path.join(__dirname, 'mocks', 'ndk', 'all', 'no-ndk-build')))
		...
		it('should error if directory is missing the "ndk-which" executable', async () => {
			await expect(AndroidNDK.load(path.join(__dirname, 'mocks', 'ndk', process.platform, 'no-ndk-which')))
