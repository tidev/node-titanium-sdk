...
Please move the Android SDK into a path without an ampersand and re-run __${commandPrefix} ti setup android__.`
	...
	for (const platform of sortedPlatforms) {
		...
		if (platform.type === 'platform') {
			...
			info.supported = !Number.parseInt(platform.basedOn.apiLevel, 10) || version.satisfies(platform.basedOn.apiLevel, androidPackageJson.vendorDependencies['android sdk'], true);
